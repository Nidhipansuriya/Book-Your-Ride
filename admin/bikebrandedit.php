...
<div align=center>
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">UPDATE BIKE BRAND DETAILS</h4>
                ...
                <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="bikebrand_name" id="bikebrand_name" value="<?php echo $row['bikebrand_name'];?>"  class="form-control" required> 
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <image src='images/<?php echo $row['bikebrand_photo']; ?>' height=100 width=100 required> 
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label">New Logo</label>
                        <div class="col-sm-9">
                            <input type="file" class="form-control" name="bikebrand_photo" id="bikebrand_photo" placeholder="Brand Logo" required>
                        </div>
                    </div>
    ...
    <?php
                    if(isset($_POST["submit"]))
                    {
                      ...
                      //  $brand_logo=$_POST['brand_logo'];
                        ...
                        $q=mysqli_query($con,"update bikebrandmaster set bikebrand_name='$bikebrand_name',bikebrand_photo='$file_name' where bikebrand_id='$bikebrand_id'");
                        // $row=mysqli_fetch_array($q);
                        ...
                        if($q)
                        {
                            ...
                            echo "<script>window.location.assign('bikebrand.php');</script>";
                        }
                        else
                        {
