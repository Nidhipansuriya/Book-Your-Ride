...
<body>
  ...
  if (isset($_POST['submit'])) {
    ...
    $aid = $_SESSION['aid'];
    //echo $email;
    $q = mysqli_query($con, "select * from registration where aid=$aid");
    ...
    if ($password == $password1) {
      ...
      echo "<script>alert('Please try again your passowrd does not match.');</script>";
    }
  }
  ?>
        ...
        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
          <div class="card col-lg-4 mx-auto" style="background-color: rgba(0,0,0,0.7);">
            <div class="card-body px-5 py-5">
              ...
              <h6 class="mb-20" style="color:#6c757d">Enter your current password and submit</h6>
              <br>
              <form method="POST" action="" name="">
                <div class="form-group">

                  <div class="row" style="margin-left: 0px;">
                    <input type="password" name="password" id="password" class="form-control p_input col-sm-10" placeholder="Password" required>
