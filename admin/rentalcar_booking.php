    ...
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card" style="background-color: black;">
                <div class="card-body">
                    <h4 class="card-title">Current Booked Cars</h4>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                echo "<a href='rentalcar_mail.php?car_booking_id=$row[car_booking_id]&carmodel_id=$row[carmodel_id]&cardetail_id=$row[cardetail_id]'><img src='images/car-return.png'></a>";
                                                ?>
                                            </td>
