			...
			<div class="row align-items-center">
				...
				<div class="col-md-6">
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						<h6 class="mb-20">CHECK YOUR EMAIL FOR VERIFICATION CODE</h6>
						<form method="POST" >
							<div class="input-group custom">
								<input type="text" name="otp" id="otp" class="form-control form-control-lg" placeholder="Verification Code" required>
							...
							<div class="row align-items-center">
								<div class="col-5">
									<div class="input-group mb-0">
											...
											<input class="btn btn-primary btn-lg btn-block" type="submit" name="verify_email" value="Submit">
