            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        ...
                        <h6 class="mb-20">Enter your current password and submit</h6>
                        <form method="POST" enctype="multipart/form-data" name="reset">
                            <div class="input-group custom">
                                <input type="password" class="form-control form-control-lg" name="password" id="password" placeholder="Current Password" required>
                            ...
                            <!-- <div class="input-group custom">
                                <input type="text" class="form-control form-control-lg" name="newpassword" id="newpassword" placeholder="New Password" required>
                                <div class="input-group-append custom">
                                    <span class="input-group-text"><i class="dw dw-padlock1"></i></span>
                                </div>
                            </div>
                            <div class="input-group custom">
                                <input type="text" class="form-control form-control-lg" name="conpassword" id="conpassword" placeholder="Confirm New Password" onchange="chk()" required>
                                <div class="input-group-append custom">
                                    <span class="input-group-text"><i class="dw dw-padlock1"></i></span>
                                </div>
                            </div> -->
