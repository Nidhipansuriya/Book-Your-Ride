                        ...
                        <form class="forms-sample" name="Ride_history" method="POST">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    // $q = mysqli_query($con, "select * from kaali_peeli_booking_histrory where id=$id");
                                    $q = mysqli_query($con, "select kph.*, d.* from kaali_peeli_booking_history kph, dregis d where d.id=kph.id and d.id=$id");
