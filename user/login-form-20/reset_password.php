					...
					<div class="login-wrap p-0">
						...
						<form method="POST" enctype="multipart/form-data" class="signin-form">
							<div class="form-group">
								...
								<span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password" onclick="clickEyeButton('newpassword')"></span>
							</div>
							<div class="form-group">
								...
								<span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password" onclick="clickEyeButton('conpassword')"></span>
							</div>
							<div class="form-group">
