...
if (isset($_POST['submit'])) {
    ...
    echo "<script>window.location.assign('../login-form-20/rentalcarpreview.php?user_name=$user_name&user_contact=$user_contact&user_email=$user_email&carmodel_id=$carmodel_id&cardetail_id=$cardetail_id&liecense_no=$liecense_no&front_photo=$front_photo&back_photo=$back_photo&booking_date=$booking_date&pick_date=$pick_date&return_date=$return_date&pick_time=$pick_time&price_day=$price_day&total_day=$total_day&total_amount=$total_amount')</script>";
                    ...
                    <div class="col-md-7 d-flex align-items-center">
                        <form action="" class="request-form ftco-animate bg-primary" style=" background: #0f172b !important; width: 100%;" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group ml-2">
                                ...
                                <input type="time" class="form-control" id="pick_time" name="pick_time" placeholder="Enter Here!!" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="row d-flex mb-4">
                                <div class="col-md-12 d-flex align-self-stretch ftco-animate">
                                    <div class="services w-100 text-center">
                                        ...
                                        ?>
                                            <?php
                                            echo "<div class='icon d-flex align-items-center justify-content-center' style='margin-top: 20px;''><span> <img class=' me-3' data-wow-delay='0.7s' src='../../admin/images/$row[photo]' style='height:170px; width:190px; margin-left:20px;'></span></div>";
                                            echo " <div class='text w-100' style='margin-top: 50px;'>";
                                            echo "<h3 class='heading mb-2'>$row[carmodel_name]</h3>";
                                            ?>
                                        <?php
                                        }
                                        ?>
