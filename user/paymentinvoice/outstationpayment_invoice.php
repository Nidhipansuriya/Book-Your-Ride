...
<body>
    ...
    <div class="container">
        ...
        <div class="row m-0">
            ...
            $q = mysqli_query($con, "select oc.*,ocb.* from outstation_car oc, outstation_booking ocb where oc.outstat_car_id=$outstat_car_id and ocb.outstat_car_id=$outstat_car_id");
            ...
            ?>
                <div class="col-lg-7 pb-5 pe-lg-5">
                    <div class="row">
                        ...
                        <?php
                        echo "<div class='col-12 p-5' style='margin-left:80px;' > <img src='../../admin/images/$row[outstat_car_photo]'  style=' width: 450px;'> </div>";
                        ?>
                        <div class="row  bg-light" style="padding-top: 15px; padding-left: 20px; width: 80%; margin-left: 130px; margin-left: 130px;">
                            ...
                            <div class="col-md-6 col-6 ps-30 my-4">
                                <p class="h5 ">Drop City</p>
                                <p class="text-muted"><?php echo "$row[drop_city]"; ?></p>
                            </div>
                    ...
                    <div class="row m-0">
                        <div class="col-12 px-4" style="margin-top: 37px;">
                            <div class="d-flex align-items-end mt-4 mb-2">
                                <p class="h4 m-0"><?php echo $row['outstat_car_name'] ?></p>
                            </div>
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <p class="fs-14 fw-bold"><span class="fas fa-dollar-sign pe-1"><?php echo "&#8377 $row[price_day]"; ?></span></p>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <p class="textmuted">Total Days</p>
                                <p class="fs-14 fw-bold"><?php echo "$row[total_days]"; ?></p>
                            </div>
                            <!-- <div class="d-flex justify-content-between mb-2">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <div class="d-flex align-text-top "> <span class="fas fa-dollar-sign mt-1 pe-1 fs-14 "></span><span class="h4"><?php echo "&#8377 $row[total_amount]"; ?></span> </div>
                            </div>
                        </div>
                                ...
                                <div class="row bg-light m-0">
                                    ...
                                    <div class="col-12 px-4">
                                        ...
                                        <div class="d-flex mb-5" style="margin-top: -25px;"> <span class="me-5">
                                                ...
                                                <input class="form-control" type="textbox" name="amt" id="amt" value="<?php echo $row['total_amount'] ?>" style="width: 365px;" readonly /><br /><br />
                                    ...
                                    <div class="col-12 ">
                                        <input type="button" name="btn" id="btn" style="margin-left:80px" value="Pay Now" class="btn btn-byr" onclick="pay_now()" />
                                    </div>
                                </div>
                                <div class="row m-0">
                                    <div class="col-12 mb-4 p-0">
                                        <!-- <div class="btn btn-primary">Purchase<span class="fas fa-arrow-right ps-2"></span> </div> -->
                                        <!-- <input type="button" name="bookingcancel" id="bookingcancel" value="Cancel Booking" class="btn btn-byr" /> -->
                                        <?php
                                        ...
                                        echo "<p class='d-flex mb-0 d-block'><a href='outstation_cancel.php?x=$row[out_booking_id]&y=$row[id]' class='btn btn-byr mr-2' style='margin-left: 200px; margin-top: -50px; height: 38px;'>Cancel Booking</a></p>";
                                        ?>
                                    </div>
                                </div>
                            </div>
