...
<body>
    ...
    <a href="../index.php" class="navbar-brand p-0">
        ...
        <div class="row m-0">
            ...
            $q = mysqli_query($con, "select cm.*,cd.*,rcb.* from carmodel cm, cardetail cd, rental_car_booking rcb where cm.carmodel_id=$carmodel_id and cd.cardetail_id=$cardetail_id and rcb.carmodel_id=$carmodel_id");
                    ...
                    <div class="row m-0">
                        <div class="col-12 px-4" style="margin-top: 37px;">
                            <div class="d-flex align-items-end mt-4 mb-2">
                                <p class="h4 m-0"><?php echo $row['carmodel_name'] ?></p>
                            </div>
                            ...
                            <div class="col-12 px-0">
                                ...
                                <div class="row m-0">
                                    <div class="col-12 mb-4 p-0">
                                        ...
                                        echo "<p class='d-flex mb-0 d-block'><a href='car_cancel.php?x=$row[car_booking_id]' class='btn btn-byr mr-2' style='margin-left: 200px; margin-top: -50px; height: 38px;'>Cancel Booking</a></p>";
                                        ?>
                                    </div>
                                </div>
                            </div>
