...
<body>
    ...
    <a href="../index.php" class="navbar-brand p-0">
        ...
        <div class="row m-0">
            ...
            $q = mysqli_query($con, "select bm.*,rbb.* from bikemaster bm, rental_bike_booking rbb where bm.bike_id=$bike_id and rbb.bike_id=$bike_id");
            ...
            ?>
                <div class="col-lg-7 pb-5 pe-lg-5">
                    <div class="row">
                        ...
                        <?php
                        echo "<div class='col-12 p-5' style='margin-left:80px;' > <img src='../../admin/images/$row[bike_photo]'  style=' width: 450px;'> </div>";
                        ?>
                        <div class="row  bg-light" style="padding-top: 15px; padding-left: 20px; width: 80%; margin-left: 130px; margin-left: 130px;">
                            ...
                            <div class="col-md-6 col-6 ps-30 my-4">
                                <p class="h5 ">Bike Number Plate</p>
                                <p class="text-muted"><?php echo "$row[number_plate]"; ?></p>
                            </div>
                           
                            <div class="col-md-6 col-6 ps-30 pe-0 my-4">
                                <p class="h5">Pick Up Date</p>
                                <p class="text-muted"><?php echo "$row[pick_date]"; ?></p>
                            </div>
                            <div class="col-md-6 col-6 ps-30 my-4">
                                <p class="h5">Return Date</p>
                                <p class="text-muted"><?php echo "$row[return_date]"; ?></p>
                            </div>
                    ...
                    <div class="row m-0">
                        <div class="col-12 px-4" style="margin-top: 37px;">
                            <div class="d-flex align-items-end mt-4 mb-2">
                                <p class="h4 m-0"><?php echo $row['bike_name'] ?></p>
                            </div>
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <p class="fs-14 fw-bold"><?php echo "$row[total_day]"; ?></p>
                            </div>
                            <!-- <div class="d-flex justify-content-between mb-2">
                            ...
                            <div class="col-12 px-0">
                                ...
                                <div class="row m-0">
                                    <div class="col-12 mb-4 p-0">
                                        ...
                                        echo "<p class='d-flex mb-0 d-block'><a href='bike_cancel.php?x=$row[bike_booking_id]' class='btn btn-byr mr-2' style='margin-left: 200px; margin-top: -50px; height: 38px;'>Cancel Booking</a></p>";
                                        ?>
                                    </div>
                                </div>
                            </div>
