                ...
                <section id="content" class="container">
                    ...
                    <div class="page-heading">
                                            ...
                                            <a href="userprofileedit.php" style="margin-left: 30px;">
                                                ...
                                                <a>
                                                    ...
                                                    <a href="userprofile.php">
                                                        ...
                                                        <span class="panel-title"> Current Booking</span>
                                                        <a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <h4 class="section-title ff-secondary text-start text-primary fw-normal mb-4" style=" margin-left: -870px;"> Bookings History</h4>
